...
<div class="container">
                ...
                @else
                  <div class="jumbotron jumbotron-fluid" style="text-align: center">
                    {!! Form::open(['action' => ['UserController@provider', Auth::user()->id], 'method' => 'get']) !!}
                    {{ Form::submit('BECOME A PROVIDER!', ['class' => 'btn btn-outline-dark']) }}
                    {{ Form::close() }}
                  </div>
                @endif
                    <h3>Your rents</h3>
